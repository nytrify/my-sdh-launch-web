...
export default function ParentGuide(){  
    ...
    const gettingStartedFeatures: Feature[] = [
      ...
      },
      {
        ...
        videoSrc: '/parent-guide-videos/ForgotPassword.mp4',
    ...
    const parentsFeatures: Feature[] = [
      {
        ...
        videoSrc: '/parent-guide-videos/Agenda.mp4',
        imageSrc: '/agenda.png',
      ...
      },
      {
        ...
        videoSrc: '/parent-guide-videos/Update.mp4',
        imageSrc: '/update.png',
            ...
            <section className="relative min-h-screen">
              ...
              <div className="relative flex flex-col items-center justify-center text-center bg-white h-max py-15">
                <div className="w-3/4 flex flex-col items-center justify-center">
                  <div ref={headingRef as React.RefObject<HTMLDivElement>} 
                    ...
                    <h1 className="text-base text-lg md:text-4xl pt-4 text-[#192553] font-sans text-center md:w-3/4">Through this application, you can:</h1>
                  </div>
                  <div ref={textRef as React.RefObject<HTMLDivElement>} 
                    ...
                    <ul className="list-disc md:text-xl pl-6 text-left space-y-2 font-sans text-[#192553] py-4">
              ...
              <div className="relative flex flex-col items-center justify-center text-center text-black bg-white py-15">
                ...
                <div className="absolute left-1/2 bottom-0 -translate-x-1/2 translate-y-1/2 z-20 flex justify-center items-center w-3/4">
                  ...
                  <h2 className="text-lg uppercase tracking-wider text-[#192553] whitespace-nowrap font-sans font-bold bg-[#dde4ed] px-4 py-1 rounded-lg shadow z-10">
